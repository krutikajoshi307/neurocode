...
'''This code uses input EEG, muscle and photometry files of epochs of specific lengths 
generated by the biosignal_processing script. It generates mean +-SD of all epochs in line graph and bar graph format, 
creates a heatmap of all epochs and computes statistical analyses. Users input pre and post event times that can be different 
for the line graph/heatmap and the bar graphs. '''
